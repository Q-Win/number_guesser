...
function feedback(){
  ...
  document.querySelector('.feedback').innerHTML = "Too High! Guess Again"
  }
  else if (guess < anwser && guess >= min ){
    document.querySelector('.feedback').innerHTML = "Too Low! Guess Again"
  }
...
function levelUp(){
  ...
  document.querySelector('.level-up').innerHTML = "You have guessed correct. You are now on the next level. The range has increased by 10 on each side of the range. "
}
